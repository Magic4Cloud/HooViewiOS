...
- (void)dateDescWithYear:(NSInteger *)year month:(NSInteger *)month day:(NSInteger *)day hour:(NSInteger *)hour minute:(NSInteger *)minute second:(NSInteger *)second
{
...
- (NSString *)weekday
{
    ...
    switch (weekday) {
        case 1:
            week = kE_GlobalZH(@"e_sunday");
            break;
        case 2:
            week = kE_GlobalZH(@"e_monday");
            break;
        case 3:
            week = kE_GlobalZH(@"e_tuesday");
            break;
        case 4:
            week = kE_GlobalZH(@"e_wednesday");
            break;
        case 5:
            week = kE_GlobalZH(@"e_thursday");
            break;
        case 6:
            week = kE_GlobalZH(@"e_friday");
            break;
        case 7:
            week = kE_GlobalZH(@"e_saturday");
            break;
...
- (NSString *)timeHourMinuteWithPrefix:(BOOL)enablePrefix suffix:(BOOL)enableSuffix
{
    ...
    if (enablePrefix) {
        timeStr = [NSString stringWithFormat:@"%@%@",([self hour] > 12 ? kE_GlobalZH(@"e_pm") :kE_GlobalZH(@"e_am")),timeStr];
    }
    if (enableSuffix) {
