...
@interface CCQueryObject ()

@end

@implementation CCQueryObject
...
@implementation CCUpdateSQLObject

@end

@implementation CCBaseObject

+ (instancetype)objectWithDictionary:(NSDictionary *)dict{
    CCBaseObject *obj = [self gp_objectWithDictionary:dict];
    return obj;
}
