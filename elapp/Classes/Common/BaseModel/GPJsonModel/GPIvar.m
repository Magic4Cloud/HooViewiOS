...
static NSArray *_boolTypeArray;
static NSArray *_intTypeArray;
static NSArray *_floatTypeArray;
static NSArray *_stringTypeArray = nil;
+ (void)initialize
{
    ...
    _directKeyValueTypes = @[/*@"NSObject",@"NSException",@"NSNumber",@"NSDate"*/@"NSString",@"NSMutableString",@"c",@"i",@"s",@"l",@"q",@"c",@"I",@"S",@"L",@"Q",@"f",@"d",@"B",@"*",@"NSNumber"];
    // 集合类型,需要遍历
    ...
    _boolTypeArray = @[
                       ...
                       [NSString stringWithUTF8String:@encode(bool)],
                       [NSString stringWithUTF8String:@encode(Boolean)],
                       [NSString stringWithUTF8String:@encode(char)],
                       ];
    _intTypeArray = @[
                       [NSString stringWithUTF8String:@encode(NSUInteger)],
                       [NSString stringWithUTF8String:@encode(NSInteger)],
    ...
    _floatTypeArray = @[
                      ...
                      [NSString stringWithUTF8String:@encode(CGFloat)]
                      ];
...
+ (NSArray *)boolTypeArray
{
    return _boolTypeArray;
}

+ (NSArray *)intTypeArray
{
    return _intTypeArray;
}

+ (NSArray *)floatTypeArray
{
    return _floatTypeArray;
}

+ (NSArray *)stringTypeArray
{
    return _stringTypeArray;
}
...
- (instancetype)initWithIvar:(Ivar)ivar fromObject:(id)obj{
    ...
    if ( self = [super init] ) {
        ...
        // 判断其类型
        if ( [_directKeyValueTypes containsObject:self.typeEncode] || [_floatTypeArray containsObject:self.typeEncode] || [_intTypeArray containsObject:self.typeEncode] || [_boolTypeArray containsObject:self.typeEncode] ) {
