...
- (void)setPageOriginY:(CGFloat)pageOriginY
{
    _pageOriginY = pageOriginY;
    [self setupPageControl];
    /** 当前需求没有针对于自定义 PageControl 的需求，暂不判断 TAPageControl 逻辑 */
}
...
//    if (_pageControl) [_pageControl removeFromSuperview]; // 重新加载数据时调整
     ...
     */
    if (_pageControl && !CGSizeEqualToSize(_pageControl.frame.size, CGSizeZero)) {
        UIPageControl *pageControl = (UIPageControl *)_pageControl;
