...
@interface EVRedEnvelopeItemModel : CCBaseObject
...
@property (nonatomic,assign) int flag;      // 红包触发标志（数字，1-发红包，0-拆过红包的人）
...
@property (nonatomic, copy) NSString *ecoin;        // 所领取的金额（数字 单位云币）
...
@interface EVRedEnvelopeModel : CCBaseObject
