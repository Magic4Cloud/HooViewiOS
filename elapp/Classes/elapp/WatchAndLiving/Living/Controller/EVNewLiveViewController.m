...
@interface EVNewLiveViewController ()< UIActionSheetDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate,EVControllerContacterProtocol, UzysImageCropperDelegate, EVLiveBottomItemViewDelegate, EVLiveEndViewDelegate, EVLiveSliderDelegate, CCLiveAnchorSendRedPacketViewDelegate,EVLivePrePareViewDelegate,EVVideoCodingDelegate,EVLivePrePareViewDelegate,EVLimitViewControllerDelegate,EVMusicViewDelegate,EVSDKMessageDelegate,UIGestureRecognizerDelegate,UITextFieldDelegate>
...
@implementation EVNewLiveViewController

#pragma mark - ***********         Init💧         ***********
//轮播图可能会用到
+ (instancetype)liveViewControllerWithActivityInfo:(NSDictionary *)params
{
    EVNewLiveViewController *livingVC = [[EVNewLiveViewController alloc] init];
...
{
    EVLog(@"==============================  %ld",(long)self.isVideoTimer);
    self.isVideoTimer ++;
}
