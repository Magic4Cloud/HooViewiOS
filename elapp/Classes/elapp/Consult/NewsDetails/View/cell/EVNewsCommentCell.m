...
@implementation EVNewsCommentCell
...
//    [EVLineView addLightTopLineToView:self];
    ...
    backView.backgroundColor = CCColor(250, 250, 250);
    [backView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:10];
    [backView autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:10];
    [backView autoPinEdgeToSuperviewEdge:ALEdgeTop];
    [backView autoPinEdgeToSuperviewEdge:ALEdgeBottom];
    
    UIImageView *headImageView = [[UIImageView alloc] init];
    [self addSubview:headImageView];
    [headImageView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:20];
    ...
    [lineView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:10];
