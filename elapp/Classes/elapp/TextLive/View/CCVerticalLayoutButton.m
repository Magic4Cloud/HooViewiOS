...
//  Copyright (c) 2015年 yizhibo. All rights reserved.
//

#import "CCVerticalLayoutButton.h"
#import <PureLayout.h>

@interface CCVerticalLayoutButton ()
...
@implementation CCVerticalLayoutButton
...
{
    CCVerticalLayoutButton *btn = [super buttonWithType:buttonType];
    [btn setUpSubviews];
    return btn;
}
...
- (void)setUpSubviews
{
    ...
    _myLabel = myLabel;
    myLabel.font = [UIFont textFontB2];
    myLabel.textAlignment = NSTextAlignmentCenter;
    myLabel.textColor = [UIColor evTextColorH2];
...
- (void)setSelected:(BOOL)selected
{
    ...
    if (selected)
    {
        ...
        self.myLabel.textColor = [UIColor evTextColorH2];
    }
    else
    {
