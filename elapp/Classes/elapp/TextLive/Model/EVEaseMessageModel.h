...
typedef NS_ENUM(NSInteger, EVEaseMessageType) {
    ...
    EVEaseMessageTypeReply,
    EVEaseMessageTypeImage,
};

typedef NS_ENUM(NSInteger, EVEaseMessageTypeState) {
    EVEaseMessageTypeStateNor,
...
@property (nonatomic, assign) CGRect backContentRect;

@property (nonatomic, assign) CGFloat chatCellHight;


@property (nonatomic, assign) CGFloat rpcHig;
@property (nonatomic, copy) NSString *rpContent;

@property (nonatomic, assign) BOOL isReply;

@property (nonatomic, assign) CGFloat cHig;

@property (nonatomic, assign) CGFloat rpLhig;
