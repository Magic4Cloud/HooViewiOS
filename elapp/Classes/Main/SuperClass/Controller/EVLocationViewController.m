...
static EVLocationViewController *defaultLocation = nil;

@interface EVLocationViewController () <MKMapViewDelegate,CLLocationManagerDelegate>
{
    MKMapView *_mapView;
...
@implementation EVLocationViewController
...
- (void)viewDidLoad
{
    ...
    self.title = self.mytitle.length == 0 ? kE_GlobalZH(@"findLocation") : self.mytitle;
...
+ (instancetype)defaultLocation
{
    ...
    dispatch_once(&onceToken, ^{
        defaultLocation = [[EVLocationViewController alloc] initWithNibName:nil bundle:nil];
    });
